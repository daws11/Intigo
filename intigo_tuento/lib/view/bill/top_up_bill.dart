...
class TopUpBill extends StatelessWidget {
  const TopUpBill({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        decoration: BoxDecoration(image: backgroundImagePrimary),
        child: Column(
          children: [
            Padding(
              padding: const EdgeInsets.only(left: 14, top: 59),
              child: AppBarCustom1(header: "Top up"),
            ),
            SizedBox(height: 19),
            Padding(
              padding: const EdgeInsets.only(left: 26.62, right: 24),
              ...
              child: ListView(
                children: [
                  Padding(
                    ...
                    child:
                        Text("Pembayaran dengan Kode QR", style: monts16W600),
                  ),
                  SizedBox(height: 7),
                  TombalPembayaran("QRIS", "qris"),
                  SizedBox(height: 28),
                  Padding(
                    padding: const EdgeInsets.only(left: 24),
                            ...
                            child: Row(
                              children: [
                                Iconify(Bi.credit_card_2_front,
                                    color: white, size: 24),
                                SizedBox(width: 17),
                                Text("Credit Card", style: isiNotif700),
                              ],
                            )),
                      ),
                    ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 24),
                    child: Text("Transfer Virtual Account", style: monts16W600),
                  ),
                  SizedBox(height: 7),
